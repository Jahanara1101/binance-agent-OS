...
def main() -> None:
    ...
    # Spot defaults: max 5 open orders, fixed $6 notional per order (futures
    # stays 30 orders / 2% per leg). These are the safe public defaults for spot.
    if venue == "spot" and args.max_orders == 30:  # user didn't override
        args.max_orders = 5
